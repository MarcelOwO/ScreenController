...
<<<<<<<< HEAD:source/file_processor/decoders/decoder_factory.cpp
========
#include <file_type.h>
>>>>>>>> origin/dev:source/processor/src/decoders/decoder_factory.cpp
...
<<<<<<<< HEAD:source/file_processor/decoders/decoder_factory.cpp
std::unique_ptr<Decoder> DecoderFactory::create(std::string_view name,
