...
public:
  explicit BluetoothLeAdvertisingManager(ILogger& logger,
  ...
  BluetoothLeAdvertisingManager& operator=(const BluetoothLeAdvertisingManager&) = delete;
  BluetoothLeAdvertisingManager(const BluetoothLeAdvertisingManager&&) = delete;
  BluetoothLeAdvertisingManager& operator=(const BluetoothLeAdvertisingManager&&) = delete;
  ...
  [[nodiscard]] std::optional<std::vector<std::string>> GetSupportedSecondaryChannels() const;
  [[nodiscard]] std::optional<std::unordered_map<std::string, sdbus::Variant>>
  GetSupportedCapabilities() const;
  [[nodiscard]] std::optional<std::vector<std::string>> GetSupportedFeatures() const;
