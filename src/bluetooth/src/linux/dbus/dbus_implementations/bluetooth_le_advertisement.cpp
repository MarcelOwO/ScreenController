...
#include "bluetooth_le_advertisement.hpp"
...
BluetoothLEAdvertisement::BluetoothLEAdvertisement(
    ...
    : logger_(logger),
      le_advertisement_interface_name_(sdbus::InterfaceName("org.bluez.LEAdvertisement1")),
  ...
  le_advertisement_
      ->addVTable(
          ...
          sdbus::registerProperty("ServiceUUIDs").withGetter([=] {
            return std::vector<std::string>{std::string("69696969-6969-6969-6969-696969696969")};
          }))
